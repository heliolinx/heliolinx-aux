// February 24, 2025: arctrace01_6Dh.cpp
...
{
  cerr << "Usage: arctrace01_6D -cfg configfile -observations obsfile -mjd starting_mjd -statevec x y z vx vy vz -minchi min_chi_change -obscode obscodefile -outfile outfile \n";
}
