// May 10, 2024: link_purify_gradddec:
...
int main(int argc, char *argv[])
{
  ...
  status = link_purify_graddec(image_log, detvec, clustvecmain, clust2detmain, config, outclust, outclust2det);
  if(status!=0) {
