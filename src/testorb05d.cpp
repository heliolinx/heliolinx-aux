// October 11, 2025: testorb05c.cpp:
...
{
  cerr << "Usage: testorb05c -cfg configfile -observations obsfile -obscode obscodefile -mjdref mjdref -statevec x y z vx vy vz -testtimes testtimes -outfile outfile -verbose verbosity\n";
}
...
int main(int argc, char *argv[])
{
  ...
  for(i=0; i<long(obsMJD.size()); i++) {
    ...
    if(i == long(obsMJD.size()-1)) {
      // We are on the last point. Print analytical and numerical derivatives
