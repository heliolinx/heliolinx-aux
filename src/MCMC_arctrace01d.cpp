...
{
  cerr << "Usage: MCMC_arctrace01d -cfg configfile -ranseed random_number_seed -observations obsfile -mjd starting_mjd -statevec x y z vx vy vz -maxnum maxnum -repnum repnum -obscode obscodefile -outfile outfile -repfile repfile\n";
}
