...
int main(int argc, char *argv[])
{
  ...
  arctrace02(polyorder,planetnum,planetmjd,planetmasses,planetpos,Sunpos,Sunvel,observerpos,obsMJD,obsRA,obsDec,sigastrom,kepspan,minchichange,startpos,startvel, bestRA, bestDec, bestresid, outpos, outvel, &bestchi, &astromrms, &refpoint);
