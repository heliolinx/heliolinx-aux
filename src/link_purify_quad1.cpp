...
int main(int argc, char *argv[])
{
  ...
  status = link_purify_quad1(image_log, detvec, clustvecmain, clust2detmain, config, outclust, outclust2det);
  if(status!=0) {
