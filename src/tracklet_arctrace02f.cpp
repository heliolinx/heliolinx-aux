// tracklet_arctrace02f.cpp: April 07, 2025:
...
int main(int argc, char *argv[])
{
  ...
  if(matchnum>1) {
	...
	return(status);
      ...
      // Loop over all of the tracklets after twinfitct in the ordered list
      for(matchct=twinfitct+1;matchct<matchnum;matchct++) {
